    ...
    <div className="w-full min-h-screen font-sans text-brand-text overflow-x-hidden bg-white pb-24 xl:pb-28">
        ...
        <div className="max-w-[1920px] mx-auto px-5 xl:px-20 flex justify-between items-center">
          ...
          <a href="#" onClick={scrollToTop} className="flex items-center gap-2 z-50">
             <div className={`font-bold text-2xl xl:text-3xl flex items-center gap-2 ${isScrolled ? 'text-brand-text' : 'text-white'}`}>
                <img src={isScrolled ? "/source/logo.png" : "/source/logo_white.svg"} alt="위드네트웍스 로고" className="h-16 xl:h-20 w-auto" />
                위드네트웍스
             </div>
          </a>
                    ...
                    <FadeIn>
                        ...
                        <div className="space-y-6 text-gray-600 text-lg" style={{ lineHeight: '1.8' }}>
                            ...
                            <div className="space-y-1">
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />진료·원무·청구 흐름 점검 및 개선</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />인력 운영 및 조직 관리 컨설팅</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />매출 구조 분석 및 수익성 개선</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />병원 맞춤 운영·관리 가이드 제공</p>
                            </div>
                        </div>
                    </FadeIn>
                </div>
                ...
                <div className="flex-1">
                    <FadeIn>
                        ...
                        <div className="space-y-6 text-gray-600 text-lg" style={{ lineHeight: '1.8' }}>
                            ...
                            <div className="space-y-1">
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />진료·운영 시스템 표준화</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />공동 마케팅 및 브랜드 연계</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />메이저 방송·언론사와의 연계를 통한 신뢰도 구축</p>
                                <p className="flex items-center gap-2 text-black"><Check className="w-5 h-5 text-brand shrink-0" />네트워크 병원 간 정보·노하우 공유</p>
                            </div>
                            <p>
                                각 병원의 자율성은 지키면서,<br />
      ...
      <section className="bg-[#2D2D2D] py-32 xl:py-48 relative overflow-hidden">
        ...
        <div className="container mx-auto px-5 xl:px-20 text-center relative z-10">
          <FadeIn direction="up">
            {/* Main English Title */}
            <h2 className="text-[#2473E3] text-3xl md:text-4xl xl:text-[52px] font-light mb-8" style={{ lineHeight: '1.3' }}>
            ...
            <p className="text-white/80 text-base md:text-lg xl:text-xl max-w-3xl mx-auto" style={{ lineHeight: '1.8' }}>
              ...
              전문적인 CS 교육과 관리로, <span className="text-[#2473E3] font-medium">위드네트웍스</span>가 재진율 향상을 함께 만들어갑니다.
            </p>
          </FadeIn>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                {[
                    ...
                    <FadeIn key={i} delay={i * 0.1}>
                        <div className={`p-8 rounded-2xl h-full min-h-[220px] flex flex-col ${i === 0 ? 'bg-[#2473E3]' : 'bg-white/10 backdrop-blur-sm border border-white/20'}`}>
                            <div className="mb-4">
                                <span className={`text-sm font-bold ${i === 0 ? 'text-white/80' : 'text-[#2473E3]'}`}>{item.step}</span>
                                <div className={`w-2 h-2 rounded-full mt-2 ${i === 0 ? 'bg-white' : 'bg-[#2473E3]'}`}></div>
                            </div>
      ...
      {/* ================= FOOTER ================= */}
      <footer className="bg-gray-100 py-10 pb-28 xl:pb-14 text-xs md:text-sm text-gray-500">
          <div className="max-w-[1440px] mx-auto px-5 xl:px-20">
              <div className="font-bold text-lg text-gray-800 mb-4">위드네트웍스</div>
              <div className="border-t border-gray-200 pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                      <p>상호명: 주식회사 위드네트웍스 | 대표자: 위지혜</p>
                      <p>사업자등록번호: 668-86-03447</p>
